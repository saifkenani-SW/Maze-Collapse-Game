    ...
    public class Play {
        ...
        Board board = new Board(10, 10, (row, col) -> {
            ...
            if ((row == 2 && col == 3) || (row == 5 && col == 5)) {
               map.put(new Location(2,2),new Square(Color.RED, true, SquareState.NOT_COLLAPSED, SquareType.NORMAL, SquareStrength.MEDIUM, Has.NOTHING));
              Square square=  new Square(Color.RED, true, SquareState.NOT_COLLAPSED, SquareType.NORMAL, SquareStrength.MEDIUM, Has.NOTHING);
        ...
        public void playRecursion(GameState gameState) {
            GameState nextState;
            if (lossCheck(gameState)) {
                System.err.println("this is Game : \n" + gameState + "\n\n");
